...
local getcustomassets = {
	['DogVape/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['DogVape/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['DogVape/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['DogVape/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['DogVape/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['DogVape/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['DogVape/assets/old/info.png'] = 'rbxasset://info.png',
	['DogVape/assets/old/pin.png'] = 'rbxasset://pin.png',
	['DogVape/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['DogVape/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['DogVape/assets/old/search.png'] = 'rbxasset://search.png',
	['DogVape/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['DogVape/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['DogVape/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['DogVape/assets/old/textvape.png'] = 'rbxasset://textvape.png',
	['DogVape/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['DogVape/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['DogVape/assets/old/vape.png'] = 'rbxassetid://14373395239',
	['DogVape/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('DogVape/assets/old/checkbox.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('DogVape/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('DogVape/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('DogVape/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('DogVape/assets/old/pin.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('DogVape/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('DogVape/assets/old/vape.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('DogVape/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('DogVape/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('DogVape/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('DogVape/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('DogVape/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('DogVape/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('DogVape/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('DogVape/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('DogVape/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('DogVape/assets/old/profilesicon.png'),
	...
	Function = function(val, mouse)
		if mouse then
			...
			if shared.VapeDeveloper then
				loadstring(readfile('DogVape/loader.lua'), 'loader')()
			else
				loadstring(game:HttpGet('https://raw.githubusercontent.com/new-qwertyui/CatV5/'..readfile('DogVape/profiles/commit.txt')..'/loader.lua', true))()
			end
		end
	end,
...
topbar:CreateButton({
	...
	mainapi.Save = function() end
		if isfile('DogVape/profiles/'..mainapi.Profile..mainapi.Place..'.txt') and delfile then
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('DogVape/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
VapeLogo.Image = getcustomasset('DogVape/assets/old/textvape.png')
...
VapeLogoV4.Image = getcustomasset('DogVape/assets/old/textv4.png')
