		...
		Function = function(call)
			if call then
				nofall:Clean(runService.PreSimulation:Connect(function()
					if entitylib.isAlive then
						if nofallmode.Value == 'State' and entitylib.character.Humanoid.FloorMaterial == Enum.Material.Air and entitylib.character.RootPart.Velocity.Y < -40 then
						...
						if nofallmode.Value ~= 'State' and entitylib.character.Humanoid.FloorMaterial == Enum.Material.Air and workspace:Raycast(entitylib.character.RootPart.Position, Vector3.new(0, -1000, 0), params) and entitylib.character.RootPart.Velocity.Y < (nofallmode.Value == 'Freeze' and -80 or -25.5) then
